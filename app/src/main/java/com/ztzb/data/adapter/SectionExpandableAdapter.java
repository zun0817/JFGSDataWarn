...
public class SectionExpandableAdapter extends BaseExpandableListAdapter {
     ...
     * 数据集合
     */
    private List<SafeProjectBean.ChildrenDTOXX.ChildrenDTOX> mExpandableModeList;
    /**
     * 上下文
     */
    ...
    public SectionExpandableAdapter(List<SafeProjectBean.ChildrenDTOXX.ChildrenDTOX> expandableModeList, Context context) {
    ...
    public int getChildrenCount(int groupPosition) {
        ...
        List<SafeProjectBean.ChildrenDTOXX.ChildrenDTOX.ChildrenDTO> childDataBeans = mExpandableModeList.get(groupPosition).getChildren();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        // 获取组的实体对象
        SafeProjectBean.ChildrenDTOXX.ChildrenDTOX expandableMode = mExpandableModeList.get(groupPosition);
        // 获取组名
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        SafeProjectBean.ChildrenDTOXX.ChildrenDTOX expandableMode = mExpandableModeList.get(groupPosition);
        List<SafeProjectBean.ChildrenDTOXX.ChildrenDTOX.ChildrenDTO> childDataBeans = expandableMode.getChildren();
        SafeProjectBean.ChildrenDTOXX.ChildrenDTOX.ChildrenDTO childDataBean = childDataBeans.get(childPosition);
        // 获取子名字
    ...
    public void setExpandableModeList(List<SafeProjectBean.ChildrenDTOXX.ChildrenDTOX> expandableModeList) {
        mExpandableModeList = expandableModeList;
    }
}
