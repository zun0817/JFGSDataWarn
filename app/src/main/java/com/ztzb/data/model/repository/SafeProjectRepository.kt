...
class SafeProjectRepository(private val safeProjectService: SafeProjectService) : BaseRepository() {

    private val TAG = SafeProjectRepository::class.java.simpleName
