...
import com.ztzb.data.model.remote.MonitorPointDetailService
import io.reactivex.Single

class MonitorPointDetailRepository(private val monitorPointDetailService: MonitorPointDetailService) :
    BaseRepository() {

    private val TAG = MonitorPointDetailRepository::class.java.simpleName
    ...
    fun requestOfSafeProject(projectId: Int): Single<MonitorBean> {
        val request = monitorPointDetailService.requestOfSafeProject(projectId)
