...
import com.ztzb.data.model.remote.SafeProjectService
import io.reactivex.Single

class SafeSectionRepository(private val safeProjectService: SafeProjectService) : BaseRepository() {

    private val TAG = SafeSectionRepository::class.java.simpleName
    ...
    fun requestOfSafeProject(projectId: Int): Single<MonitorBean> {
        val request = safeProjectService.requestOfSafeProject(projectId)
