...
import com.ztzb.data.model.remote.SafeMonitorPointService
import io.reactivex.Single

class SafeMonitorPointRepository(private val safeMonitorPointService: SafeMonitorPointService) :
    BaseRepository() {

    private val TAG = SafeMonitorPointRepository::class.java.simpleName
    ...
    fun requestOfSafeProject(projectId: Int): Single<MonitorBean> {
        val request = safeMonitorPointService.requestOfSafeProject(projectId)
