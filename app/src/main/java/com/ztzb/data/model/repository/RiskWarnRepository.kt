...
import com.ztzb.data.model.remote.RiskWarnService
import io.reactivex.Single

class RiskWarnRepository(private val riskWarnService: RiskWarnService) :
    BaseRepository() {

    private val TAG = RiskWarnRepository::class.java.simpleName
    ...
    fun requestOfSafeProject(projectId: Int): Single<MonitorBean> {
        val request = riskWarnService.requestOfSafeProject(projectId)
