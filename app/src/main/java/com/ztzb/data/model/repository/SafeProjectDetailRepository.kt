...
import com.ztzb.data.model.remote.SafeProjectDetailService
import io.reactivex.Single

class SafeProjectDetailRepository(private val safeProjectDetailService: SafeProjectDetailService) :
    BaseRepository() {

    private val TAG = SafeProjectDetailRepository::class.java.simpleName
    ...
    fun requestOfSafeProject(projectId: Int): Single<MonitorBean> {
        val request = safeProjectDetailService.requestOfSafeProject(projectId)
