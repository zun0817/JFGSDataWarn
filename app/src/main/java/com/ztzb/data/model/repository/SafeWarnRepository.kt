...
import com.ztzb.data.model.remote.SafeWarnService
import io.reactivex.Single

class SafeWarnRepository(private val safeWarnService: SafeWarnService) :
    BaseRepository() {

    private val TAG = SafeWarnRepository::class.java.simpleName
    ...
    fun requestOfSafeProject(projectId: Int): Single<MonitorBean> {
        val request = safeWarnService.requestOfSafeProject(projectId)
